...
- (void)addComponents:(CGRect)frame
{
    ...
    UIView *customView = [[UIView alloc] initWithFrame:CGRectMake(kAlertViewBorder, _height, frame.size.width-kAlertViewBorder*2, viewHeight)];
    customView.backgroundColor = [UIColor yellowColor];
    
    CGFloat textFieldHeight = 30.0f;
    for (int i=10; i<viewHeight-textFieldHeight; i+=40) {
        UITextField *textField = [[UITextField alloc] initWithFrame:CGRectMake(kAlertViewBorder, i, customView.bounds.size.width-kAlertViewBorder*2, textFieldHeight)];
    ...
    [_view addSubview:customView];
    [customView release];
    _height += viewHeight + kAlertViewBorder;
}
